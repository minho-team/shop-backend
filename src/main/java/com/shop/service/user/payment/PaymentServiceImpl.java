...
public class PaymentServiceImpl implements PaymentService {
    ...
    public PaymentPrepareResponseDTO preparePayment(String memberId, PaymentPrepareRequestDTO request) {
        ...
        String orderName = request.getItems().size() == 1
                ? request.getItems().get(0).getItemName()
        ...
        return PaymentPrepareResponseDTO.builder()
                ...
                .customerName(request.getOrdererName())
                .customerEmail(request.getOrdererEmail())
                .customerMobilePhone(request.getOrdererPhoneNumber())
                .build();
    }
